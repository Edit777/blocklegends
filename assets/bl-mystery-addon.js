...
(function () {
  ...
  function ensureCssOnce() {
    ...
    st.textContent = [
      ...
      '.upsell[data-upsell-addon="true"] .bl-addon-main{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;column-gap:0.85rem;row-gap:0.5rem;}',
      '.upsell[data-upsell-addon="true"] .upsell__image{align-self:stretch;display:flex;align-items:center;flex:0 0 76px;width:76px;}',
      '.upsell[data-upsell-addon="true"] .upsell__image .upsell__image__img{width:100%;max-width:76px;height:auto;}',
      '.upsell[data-upsell-addon="true"] .bl-addon-left{min-width:0;display:flex;flex-direction:column;gap:0.4rem;}',
      '.upsell[data-upsell-addon="true"] .upsell__content{display:flex;flex-direction:column;gap:0.3rem;justify-content:center;min-width:0;}',
